...
ctdas_root = '/scratch/snx3000/nponomar/ctdas-icon_case1'
...
art_input_folder = '/scratch/snx3000/nponomar/ICON_ctdas_msteiner/ART_case1'
...
ctdas_tracer = 'co2'
ctdas_observations = '/scratch/snx3000/nponomar/ICOS_obs_data/Extracted_obs_case_1/Extracted_ZHcyl_obs__20220701_20221223alldates_masl_inlet_cyl.nc'
ctdas_observations_dir = '/scratch/snx3000/nponomar/ICOS_obs_data/Extracted_obs_case_1'
ctdas_dir = '/scratch/snx3000/nponomar/ctdas-icon_case1/exec'
...
ctdas_datadir = '/scratch/snx3000/nponomar/ICOS_obs_data/Extracted_obs_case_1'
...
ctdas_restart_template = '/scratch/snx3000/nponomar/ICON_ctdas_msteiner/runscripts/CTDAS/templates_ZH/runscript_template_icos_ZH_synth'
...
# ICON -----------------------------------------------------------------------
# Executable
icon_bin = os.path.join(exe_dir, "icon_4merging")
