...
ctdas_root = '/capstor/scratch/cscs/nponomar/ctdas-icon_case10'
...
input_root_grid_ICOS = '/capstor/scratch/cscs/nponomar/processing_chain_python/processing-chain/work/Paris_ensemble_test/icon/input/grid/'
radiation_grid_filename = os.path.join(input_root_grid_ICOS,
                                       "domain1_DOM01.parent.nc")
dynamics_grid_filename = os.path.join(input_root_grid_ICOS, "domain1_DOM01.nc")
...
art_input_folder = '/capstor/scratch/cscs/nponomar/ICON_ctdas_msteiner/ART_case10'
...
oae_gridded_emissions_nc = 'TNO_merged_with_AIRPARIF_actually_final_HR.nc'
...
oae_hourofyear_nc = 'hourofyear_July22July23_TNOPARIS_DST.nc'
...
ctdas_cycle = 7
ctdas_nlag = 2
ctdas_nreg_params = 7685#3588 #2547
ctdas_tracer = 'co2'
ctdas_observations = '/capstor/scratch/cscs/nponomar/ICOS_obs_data/Extracted_obs_case_10/Extracted_ZHcyl_obs__20220701_20221223alldates_masl_inlet_cyl.nc'
ctdas_observations_dir = '/capstor/scratch/cscs/nponomar/ICOS_obs_data/Extracted_obs_case_10'
ctdas_dir = '/capstor/scratch/cscs/nponomar/ctdas-icon_case10/exec'
...
ctdas_sv_distances = '/capstor/scratch/cscs/nponomar/CTDAS_data/Loc_Cov_matrix_distances_Paris_parent_domain.nc'
ctdas_op_loc_coeffs = '/capstor/scratch/cscs/nponomar/CTDAS_data/Loc_K_matrix_distances_Paris_parent_domain.nc' #'/capstor/scratch/cscs/nponomar/CTDAS_data/Loc_K_matrix_distances_ZH_parent_domain.nc'
...
ctdas_datadir = '/capstor/scratch/cscs/nponomar/ICOS_obs_data/Extracted_obs_case_10'
...
ctdas_ncategories = 3
ctdas_nparameters = 23063#10772 #7649 #5094 #17829 #5094 # for example: 13 co2 flux categories: A, RA, GPP * ctdas_nreg_params (number of regions used in data assimilation) + ctdas_bg_params (number of bg regions)
...
ctdas_regionsfile = '/capstor/scratch/cscs/nponomar/processing_chain_python/processing-chain/work/CTDAS_Paris_case10/2023010100_0_8760/icon/input/vprm/Regions_Paris.nc'
...
ctdas_boundary_mask_file = '/capstor/scratch/cscs/nponomar/plt_py/boundary_mask_Paris_tested_ic_8regions.nc'
...
ctdas_restart_template = '/capstor/scratch/cscs/nponomar/processing-chain/cases/runscript_templates/runscript_template_Paris_santis'
ctdas_sbatch_extract_template = '/capstor/scratch/cscs/nponomar/processing-chain/cases/runscript_templates/sbatch_extract_template_santis'
...
vprm_regions_synth_nc = 'Regions_Paris.nc' 
vprm_lambdas_synth_nc = 'Lambdas_for_vprm_ens_co2_185_ZH.nc'
boundary_regions_nc = 'boundary_mask_ZH.nc'
vprm_coeffs_nc23 = '/capstor/scratch/cscs/nponomar/processing_chain_python/processing-chain/work/CTDAS_Paris_case10/2023010100_0_8760/icon/input/vprm/VPRM_indices_ICON_PARIS_23_dates.nc'
vprm_coeffs_nc22 = '/capstor/scratch/cscs/nponomar/processing_chain_python/processing-chain/work/CTDAS_Paris_case10/2023010100_0_8760/icon/input/vprm/VPRM_indices_ICON_PARIS_23_dates.nc'
# SIMULATION =================================================================
# ICON -----------------------------------------------------------------------
# Executable
