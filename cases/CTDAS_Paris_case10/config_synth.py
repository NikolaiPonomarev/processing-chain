...
ctdas_ncategories = 2
ctdas_nparameters = 10772 #7649 #5094 #17829 #5094 # for example: 13 co2 flux categories: A, RA, GPP * ctdas_nreg_params (number of regions used in data assimilation) + ctdas_bg_params (number of bg regions)
