...
ctdas_root = '/scratch/snx3000/nponomar/ctdas-icon_case6'
...
exe_dir = "/scratch/snx3000/nponomar/icon_art_oem4merging/icon-kit/cpu/bin"
# Case directory
...
art_input_folder = '/scratch/snx3000/nponomar/ICON_ctdas_msteiner/ART_case6'
...
oae_gridded_emissions_nc = 'oem_gridded_emissions_HR_22_LPS.nc'
...
ctdas_tracer = 'co2'
ctdas_observations = '/scratch/snx3000/nponomar/ICOS_obs_data/Extracted_obs_case_6/Extracted_ZHcyl_obs__20220701_20221223alldates_masl_inlet_cyl.nc'
ctdas_observations_dir = '/scratch/snx3000/nponomar/ICOS_obs_data/Extracted_obs_case_6'
ctdas_dir = '/scratch/snx3000/nponomar/ctdas-icon_case6/exec'
...
ctdas_datadir = '/scratch/snx3000/nponomar/ICOS_obs_data/Extracted_obs_case_6'
...
ctdas_ncategories = 3
ctdas_nparameters = 8795#8786 + 9 #10772 #7649 #5094 #17829 #5094 # for example: 13 co2 flux categories: A, RA, GPP * ctdas_nreg_params (number of regions used in data assimilation) + ctdas_bg_params (number of bg regions)
...
ctdas_regionsfile = '/scratch/snx3000/nponomar/processing_chain_python/processing-chain/work/CTDAS_ZH_case6/2022090100_0_9000/icon/input/vprm/Regions_ZH_refactored_LPS.nc'
...
ctdas_LPS_mask = '/scratch/snx3000/nponomar/CTDAS_data/LPS_parent_mask_ZH.nc'
ctdas_number_of_LPS = 9
...
vprm_regions_synth_nc = 'Regions_ZH_refactored_LPS.nc' 
