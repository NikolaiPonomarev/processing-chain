...
ctdas_nparameters = 5094 # for example: 13 co2 flux categories: A, RA, GPP * ctdas_nreg_params (number of regions used in data assimilation) + ctdas_bg_params (number of bg regions)
...
ctdas_regionsfile = '/scratch/snx3000/nponomar/processing_chain_python/processing-chain/work/CTDAS_ZH/2022071400_0_504/icon/input/oae/Synth_emis_regions.nc'
...
# ICON -----------------------------------------------------------------------
# Executable
icon_bin = os.path.join(exe_dir, "icon_bg_vprm_ens_restart")
