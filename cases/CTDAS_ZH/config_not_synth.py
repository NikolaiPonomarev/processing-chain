...
extpar_filename = os.path.join(
    input_root_grid_ICOS, "icon_extpar_ZH_corine_Modified_Urban.nc")
...
ctdas_optimizer_nmembers = 186
ctdas_nparameters = 33119 # for example: 13 co2 flux categories: A, RA, GPP * ctdas_nreg_params (number of regions used in data assimilation) + ctdas_bg_params (number of bg regions)
...
ctdas_regionsfile = '/scratch/snx3000/nponomar/plt_py/Regions_ZH_parent_domain_indcs.nc'
ctdas_obs_sites_rc = os.path.join(ctdas_datadir, 'sites_weights_icos.rc')
ctdas_extract_template = '/scratch/snx3000/nponomar/ICON_ctdas_msteiner/runscripts/CTDAS/templates_ZH/extract_template_icos_ZH'
...
ctdas_boundary_mask_file = '/scratch/snx3000/nponomar/plt_py/boundary_mask_ZH_bg.nc'
...
ctdas_restart_template = '/scratch/snx3000/nponomar/ICON_ctdas_msteiner/runscripts/CTDAS/templates_ZH/runscript_template_icos_ZH'
...
vprm_regions_synth_nc = 'Regions_ZH_parent_domain_indcs.nc' 
...
# ICON -----------------------------------------------------------------------
# Executable
icon_bin = os.path.join(exe_dir, "icon_bg_vprm_ens")
